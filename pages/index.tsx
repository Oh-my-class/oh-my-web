...
const Home: NextPage = () => {
  return <div data-theme="winter" className=" w-screen h-screen absolute flex flex-row justify-center bg-base-100 font-sans bg-gradient-to-t from-white via-white to-slate-600"> 
    <div className=" w-9/12 text-center mt-14 md:mt-8">
      <img src="https://www.theanimator.co.in/icon/1998840123schoolmanagement-icon.png" alt="School Icon" className="md:w-1/4 md:h-1/8 mx-auto"/>
